...
pacman::p_load(reticulate, dplyr, qqman)
...
```{python Se crea el archivo con la posición de los SNPs de la población base}
...
os.chdir(dir_tr) # Se indica aquí el cambio hacia el directorio de trabajo que es donde esta guardado el archivo pickle creado anteriormente.
Gen_Pob_base = pickle.load(open('Gen_Pob_base', 'rb')) # Se importa el archivo que contiene los genotipos de la población base.

# Se verifica a continuación si se importo el archivo de genotipos de la población base indicando el número de individuos y su ploidia.
print(Gen_Pob_base.nbase) # 451 indiviuos de la población base.
print(Gen_Pob_base.ploidy) # Ploidia igual a 2.
```
