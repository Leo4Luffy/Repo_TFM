...
pacman::p_load(tidyverse, here, genio, BEDMatrix, tibble, purrr, pedigreemm, BGLR, scales, glue, patchwork, plotly, ggpubr, AGHmatrix, gt, ggrepel)
```
...
Resultados <- tribble(
  ~'Pedigrí', ~'0', ~'148', ~'298', ~'451', ~'Densidad',
  '5', NA, 0.45, 0.52, 0.58, '100.000',
  '2', NA, 0.55, 0.53, 0.58, '100.000',
  '3', NA, 0.48, 0.53, 0.58, '100.000',
  '1', NA, 0.53, 0.56, 0.58, '100.000',
  '4', NA, 0.50, 0.54, 0.58, '100.000',
  '5', NA, 0.46, 0.52, 0.58, '10.000',
  '2', NA, 0.56, 0.52, 0.58, '10.000',
  '3', NA, 0.49, 0.52, 0.58, '10.000',
  '1', NA, 0.53, 0.54, 0.59, '10.000',
  '4', NA, 0.51, 0.51, 0.59, '10.000',
  '5', NA, 0.43, 0.43, 0.49, '1.000',
  '2', NA, 0.53, 0.44, 0.49, '1.000',
  '3', NA, 0.49, 0.46, 0.49, '1.000',
  '1', NA, 0.52, 0.46, 0.49, '1.000',
  '4', NA, 0.48, 0.44, 0.49, '1.000',
  '5', 0.44, NA, NA, NA, '0',
  '2', 0.54, NA, NA, NA, '0',
  '3', 0.46, NA, NA, NA, '0',
  '1', 0.50, NA, NA, NA, '0',
...
Resultado_1 <- Resultados %>% # Resultados con el pedigrí 5, con 451 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 5) %>%
  arrange('Individuos genotipados') %>%
  slice(3, 6, 9, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
  geom_point(colour = 'cyan', size = 4.4, alpha = 0.4) +
  scale_y_continuous(limits = c(0.25, 0.75)) +
  labs(x = 'Densidad del marcador', y = 'Precisión de la predicción (r)', title = 'Pedigrí cinco y 451 individuos genotipados.') +
  theme_bw() +
  theme(
    axis.text = element_text(face = 'bold', size = 14),
    axis.title = element_text(face = 'bold', size = 15),
...
Resultado_2 <- Resultados %>% # Resultados con el pedigrí 5, con 298 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 5) %>%
  arrange('Individuos genotipados') %>%
  slice(2, 5, 8, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
  geom_point(colour = 'black', size = 4.8, alpha = 0.4) +
  scale_y_continuous(limits = c(0.25, 0.75)) +
  labs(x = 'Densidad del marcador', y = 'Precisión de la predicción (r)', title = 'Pedigrí cinco y 298 individuos genotipados.') +
  theme_bw() +
  theme(
    axis.text = element_text(face = 'bold', size = 14),
    axis.title = element_text(face = 'bold', size = 15),
...
Resultado_3 <- Resultados %>% # Resultados con el pedigrí 5, con 148 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 5) %>%
  arrange('Individuos genotipados') %>%
  slice(1, 4, 7, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
  geom_point(colour = 'red', size = 4.4, alpha = 0.4) +
  scale_y_continuous(limits = c(0.25, 0.75)) +
  labs(x = 'Densidad del marcador', y = 'Precisión de la predicción (r)', title = 'Pedigrí cinco y 148 individuos genotipados.') +
  theme_bw() +
  theme(
    axis.text = element_text(face = 'bold', size = 14),
    axis.title = element_text(face = 'bold', size = 15),
...
Resultado_4 <- Resultados %>% # Resultados con el pedigrí 4, con 451 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 4) %>%
  arrange('Individuos genotipados') %>%
  slice(3, 6, 9, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
  geom_point(colour = 'cyan', size = 4.4, alpha = 0.4) +
  scale_y_continuous(limits = c(0.25, 0.75)) +
  labs(x = 'Densidad del marcador', y = 'Precisión de la predicción (r)', title = 'Pedigrí cuatro y 451 individuos genotipados.') +
  theme_bw() +
  theme(
    axis.text = element_text(face = 'bold', size = 14),
    axis.title = element_text(face = 'bold', size = 15),
...
Resultado_5 <- Resultados %>% # Resultados con el pedigrí 4, con 298 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 4) %>%
  arrange('Individuos genotipados') %>%
  slice(2, 5, 8, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
  geom_point(colour = 'black', size = 4.8, alpha = 0.4) +
  scale_y_continuous(limits = c(0.25, 0.75)) +
  labs(x = 'Densidad del marcador', y = 'Precisión de la predicción (r)', title = 'Pedigrí cuatro y 298 individuos genotipados.') +
  theme_bw() +
  theme(
    axis.text = element_text(face = 'bold', size = 14),
    axis.title = element_text(face = 'bold', size = 15),
...
Resultado_6 <- Resultados %>% # Resultados con el pedigrí 4, con 148 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 4) %>%
  arrange('Individuos genotipados') %>%
  slice(1, 4, 7, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
  geom_point(colour = 'red', size = 4.4, alpha = 0.4) +
  scale_y_continuous(limits = c(0.25, 0.75)) +
  labs(x = 'Densidad del marcador', y = 'Precisión de la predicción (r)', title = 'Pedigrí cuatro y 148 individuos genotipados.') +
  theme_bw() +
  theme(
    axis.text = element_text(face = 'bold', size = 14),
    axis.title = element_text(face = 'bold', size = 15),
...
Resultado_7 <- Resultados %>% # Resultados con el pedigrí 3, con 451 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 3) %>%
  arrange('Individuos genotipados') %>%
  slice(3, 6, 9, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_8 <- Resultados %>% # Resultados con el pedigrí 3, con 298 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 3) %>%
  arrange('Individuos genotipados') %>%
  slice(2, 5, 8, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_9 <- Resultados %>% # Resultados con el pedigrí 3, con 148 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 3) %>%
  arrange('Individuos genotipados') %>%
  slice(1, 4, 7, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_10 <- Resultados %>% # Resultados con el pedigrí 2, con 451 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 2) %>%
  arrange('Individuos genotipados') %>%
  slice(3, 6, 9, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_11 <- Resultados %>% # Resultados con el pedigrí 2, con 298 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 2) %>%
  arrange('Individuos genotipados') %>%
  slice(2, 5, 8, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_12 <- Resultados %>% # Resultados con el pedigrí 2, con 148 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 2) %>%
  arrange('Individuos genotipados') %>%
  slice(1, 4, 7, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_12 | Resultado_11 | Resultado_10

Resultado_13 <- Resultados %>% # Resultados con el pedigrí 1, con 451 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 1) %>%
  arrange('Individuos genotipados') %>%
  slice(3, 6, 9, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_14 <- Resultados %>% # Resultados con el pedigrí 1, con 298 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 1) %>%
  arrange('Individuos genotipados') %>%
  slice(2, 5, 8, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_15 <- Resultados %>% # Resultados con el pedigrí 1, con 148 y 0 individuos genotipados, y distintas densidades de SNP.
  filter(Pedigrí == 1) %>%
  arrange('Individuos genotipados') %>%
  slice(1, 4, 7, 10) %>%
  ggplot(data = ., aes(x = Densidad, y = Precisión, label = Precisión)) +
...
Resultado_15 | Resultado_14 | Resultado_13
```
...
# 22. A continuación se realiza la predicción usando el AIREML-R para distintos pedigríes y diferentes densidades de SNPs.

```{r Ajuste de modelos con AIREML-R para distintos pedigríes y diferentes densidades de SNPs}


```

# 23. A continuación se usa el módulo SeqBreed escrito en Python, especificando mediante numerales dentro de los comentarios (<!-- -->) que se hizo.
...
pacman::p_load(reticulate, dplyr, qqman, here, readr, tibble, tidyr)
...
<!--
5. Usando el comando gg.GFounder(), se genera a continuación un archivo que contiene la posición de los SNPs de la población base de IND.
-->
...
pickle.dump(Gen_Pob_base, open('Gen_Pob_base', 'wb')) # El archivo generado anteriormente (Gen_Pob_base) se guarda aquí como un "archivo pickle", esto es, un archivo donde se almacena el resultado para que sea utilizado más adelante.
```
...
```{python Creación de QTNs}

os.chdir(dir_tr)

SNPs_pos = 'SNPs_pos'

gfeatures = gg.Genome(snpFile = SNPs_pos, ploidy = Gen_Pob_base.ploidy,  XChr = 'X', YChr = 'Y', MTChr = 'MT')

#gfeatures.print()

qtn = gg.QTNs(h2 = [0.60], genome = gfeatures, nqtn = 10)

qtn.get_var(gfeatures, Gen_Pob_base)
qtn.print(gfeatures)
qtn.plot(plotFile = 'qtn.png')
```

<!--
7. Se genera un pedigrí especificando el número de individuos de la generación 0 (o población base) que se quisieran cruzar y el número de hijos en la generación 2 que cada individuo por autofecundación tendría.
-->
...
F2 <- F1 %>%
  ...
  mutate(Prog2 = Prog1) %>%
  mutate(count = 3) %>% # Se indica aquí la frecuencia con la que se debe repetir una fila (al ser 3, cada fila se repetiria 3 veces, sin embargo también es posible indica por ejemplo c(2, 3), es decir, la fila 1 repetedia 2 veces y la fila 2 repetida 3 veces).
  uncount(count) %>%
  mutate(
    id = 492:611#,
    #Gen = 2
...
Pob <- bind_rows(Pob_fun, F1, F2, F3) %>%
  write_delim(here('Datos', 'Datos_IND', 'SeqBreed', 'Pedigri.txt'), delim = ' ', col_names = FALSE) # Este sería la población en su totalidad.
```
...
#pop = gg.Population(gfeatures, pedFile = Pedigri, generation = None, qtns = qtn, gfounders = Gen_Pob_base)
