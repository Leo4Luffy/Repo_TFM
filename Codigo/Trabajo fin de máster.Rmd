...
pacman::p_load(reticulate, dplyr, qqman, here, readr, tibble, tidyr, ggplot2)
...
# Se visualizan los QTNs anteriores (INTENTAR VISUALIZARLO SEGÚN https://slidetodoc.com/statistical-genomics-lecture-9-genetic-architecture-and-simulation/):

my.GM=read.table(file="http://zzlab.net/GAPIT/data/mdp_SNP_information.txt", head=T)

my.GD=read.table(file="http://zzlab.net/GAPIT/data/mdp_numeric.txt", head=T)
...
plot(my.GM[, c(2, 3)])
lines(my.GM[QTN.position, c(2, 3)], type="p", col="red")
points(my.GM[QTN.position, c(2, 3)], type="p", col="blue", cex = 5)
```
...
<!--
10. Se genera un pedigrí especificando el número de individuos de la generación 0 (o población base) que se quisieran cruzar y el número de hijos en la generación 2 que cada individuo por autofecundación tendría.
-->
