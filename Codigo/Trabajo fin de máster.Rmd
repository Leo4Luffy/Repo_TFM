...
# 5. Se calculan los valores genéticos aditivos fenotipos, los fenotipos y las varianzas genéticas aditivas ----
...
# 5. Se calculas los valores genéticos aditivos, los fenotipos y las varianzas genéticas aditivas ----
...
# 5. Se calculan los valores genéticos aditivos, los fenotipos y las varianzas genéticas aditivas ----
...
ebv_aBLUP = pd.DataFrame(ebv_aBLUP)
ebv_aBLUP.to_csv (r'Pedigri_2/chip_0/ebv_1.csv', index = False, header = True)

y_aBLUP = np.array(list(Pob_2.inds[i].y[itrait] for i in range(Pob_2.n)))
y_aBLUP = pd.DataFrame(y_aBLUP)
y_aBLUP.to_csv (r'Pedigri_2/chip_0/Fenotipo_1.csv', index = False, header = True)
...
ebv_aBLUP = pd.DataFrame(ebv_aBLUP)
ebv_aBLUP.to_csv (r'Pedigri_3/chip_0/ebv_1.csv', index = False, header = True)

y_aBLUP = np.array(list(Pob_3.inds[i].y[itrait] for i in range(Pob_3.n)))
y_aBLUP = pd.DataFrame(y_aBLUP)
y_aBLUP.to_csv (r'Pedigri_3/chip_0/Fenotipo_1.csv', index = False, header = True)
...
ebv_aBLUP = pd.DataFrame(ebv_aBLUP)
ebv_aBLUP.to_csv (r'Pedigri_4/chip_0/ebv_1.csv', index = False, header = True)

y_aBLUP = np.array(list(Pob_4.inds[i].y[itrait] for i in range(Pob_4.n)))
y_aBLUP = pd.DataFrame(y_aBLUP)
y_aBLUP.to_csv (r'Pedigri_4/chip_0/Fenotipo_1.csv', index = False, header = True)
...
ebv_1 <- read_delim(here('Datos', 'Datos_IND', 'SeqBreed', 'Pedigri_1', 'chip_1', 'Geno_1', 'ebv_1.csv'), delim = ' ', col_names = FALSE) # Se importa el .

Fenotipo_1 <- read_delim(here('Datos', 'Datos_IND', 'SeqBreed', 'Pedigri_1', 'chip_1', 'Geno_1', 'Fenotipo_1.csv'), delim = ' ', col_names = FALSE) # Se importa el .

Cor <- bind_cols(ebv_1, Fenotipo_1) %>%
  summarise(cor(X1...1, X1...2)) # Dio una correlación de .
```
