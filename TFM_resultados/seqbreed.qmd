...
pickle.dump(Gen_Pob_base, open('Gen_Pob_base', 'wb'))
```
...
Gen_Pob_base = pickle.load(open('Gen_Pob_base', 'rb'))
...
::: {.callout appearance="minimal"}
<i class="bi bi-download"></i> [Datos GWAS](datos/QTN.txt){download="QTN.txt"}
:::
