...
```{r, echo = FALSE, out.width = "68%", fig.align = 'center', message = FALSE}
...
<P align="justify">Aunque a mayor cantidad de marcadores mejor será la predicción, se ha demostrado también que por encima de ciertas densidades es difícil mejorar significativamente la precisión de la predicción<sup>1</sup>.</p>
...
tribble(
  ...
  'Arroz', '7.142 (73.147)', 'Spindel, Begum, Akdemir et al. (2021)',
...
<P align="justify"><FONT SIZE=2>[1] `r Citet(mi_Bib, "cite:32_b")`.</FONT></p>

<P align="justify"><FONT SIZE=2>[1] `r Citet(mi_Bib, "cite:78")`.</FONT></p>

<P align="justify"><FONT SIZE=2>[1] `r Citet(mi_Bib, "cite:83")`.</FONT></p>

<P align="justify"><FONT SIZE=2>[1] `r Citet(mi_Bib, "cite:82")`.</FONT></p>

<P align="justify"><FONT SIZE=2>[1] `r Citet(mi_Bib, "cite:79")`.</FONT></p>
...
PrintBibliography(bib = mi_Bib, start = 7, end = 12)
```
...
PrintBibliography(bib = mi_Bib, start = 13, end = 17)
```
...
PrintBibliography(bib = mi_Bib, start = 18, end = 18)
```
