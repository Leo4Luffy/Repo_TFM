...
.panel[.panel-name[Matriz de parentesco]

<P align="justify">La matriz **G**, <sup>1</sup>.</p>
...
ggplot() +
  ...
  annotate(geom = 'text', x = 1.8, y = 0.8, label = '-0.40', size = 7.2, colour = 'black') +
  annotate(geom = 'text', x = 2.4, y = 0.8, label = '-0.40', size = 7.2, colour = 'black') +
  annotate(geom = 'text', x = 3.0, y = 0.8, label = '-0.67', size = 7.8, colour = 'black') +
  
  annotate(geom = 'text', x = 1.2, y = 0.6, label = '-0.40', size = 7.2, colour = 'black') +
  ...
  annotate(geom = 'text', x = 1.2, y = 0.4, label = '-0.40', size = 7.2, colour = 'black') +
...
.panel[.panel-name[Múltiples pasos]
...
data.frame(
  ...
  annotate(geom = 'text', x = 11.45, y = 4.95, label = 'observaciones', size = 7.8, colour = 'black') +
