...
pacman::p_load(metathis, xaringanExtra, fontawesome, RefManageR, here, readr, ggplot2, dplyr, latex2exp, showtext, ggforce, magick) # Aquí (https://pkg.garrickadenbuie.com/xaringanExtra/#/) y aquí (https://github.com/gadenbuie/xaringanExtra) explican las muchas opciones de usar el paquete xaringanExtra.
...
.panel[.panel-name[Modelos de selección genómica] 
...
data.frame(
  ...
  annotate(geom = 'text', x = 5.0, y = 8.7, label = 'Modelos de', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 5.0, y = 8.3, label = 'regresión', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.5, y = 6.7, label = 'Modelos lineales', size = 7.4, colour = 'black') +
  annotate(geom = 'text', x = 2.5, y = 6.3, label = 'mixtos', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 7.5, y = 6.7, label = 'Bayesianos', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.8, y = 5.3, label = 'rrBLUP', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.8, y = 4.7, label = 'GBLUP', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 7.8, y = 5.7, label = 'BayesA', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 7.8, y = 5.1, label = 'BayesB', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 7.8, y = 4.5, label = 'BayesC', size = 7.4, colour = 'black') +
  ...
  annotate(geom = 'text', x = 7.8, y = 3.9, label = 'LASSO', size = 7.4, colour = 'black') +
...
<P align="center"><FONT SIZE=2>Figura adaptada de `r Citet(mi_Bib, "cite:31")`.</FONT></p>
