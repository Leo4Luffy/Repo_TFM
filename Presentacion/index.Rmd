...
<P align="justify">Estudios que han evaluado la posibilidad de usar menos cantidad de marcadores sin afectar la precisión de la predicción genómica:</p>

```{r, echo = FALSE, out.width = "100%", message = FALSE}

tribble(
  ~'Especie ', ~'Marcadores', ~'Precisión', ~'Referencia',
  'Arroz', '7.142 ()', ' ', 'Kyselova, Tichý, and Jochová (2021)',
  'Bovino', '()', '', 'Zhu, Zhang, Niu et al. (2017)',
  'Camaron', '3.200 ()', '', 'Wang, Yu, Yuan et al. (2017)'
  ) %>%
  gt() %>%
  opt_table_lines()
```
...
PrintBibliography(bib = mi_Bib, start = 13, end = 15)
```
