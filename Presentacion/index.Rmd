...
<P align="justify">El número de individuos genotipados necesarios para ubicar un punto de rendimiento decreciente suele tener un costo prohibitivamente alto<!--<sup>2</sup>-->.
...
tribble(
  ...
  'Cítrico', '', '', 'Imai, Kuniga, Yoshioka et al. (2019)',
  'Árbol', '', '', 'Ratcliffe, El-Dien, Cappa et al. (2017)',
  'Gallina', '', '', 'Lourenco, Fragomeni, Tsuruta et al. (2015)'
  ) %>%
  gt() %>%
  tab_spanner(
    label = 'Precisión',
...
PrintBibliography(bib = mi_Bib, start = 17, end = 22)
```
...
PrintBibliography(bib = mi_Bib, start = 23, end = 24)
```
