...
<P align="justify">Se usaron los conjuntos de datos del [Rice SNP-Seek Database](http://iric.irri.org/), editados en estudio previo<sup>1</sup>. Adicionalmente, se consieró un MAF inferior a 0.5.</p>
...
PrintBibliography(bib = mi_Bib, start = 1, end = 7)
```
...
PrintBibliography(bib = mi_Bib, start = 8)
```
